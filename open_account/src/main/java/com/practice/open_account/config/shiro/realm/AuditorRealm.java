 ...
 */
public class AuditorRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken)
        ...
        JSONObject auditor=null;
        //实际项目中，这里可以根据实际情况做缓存，如果不做，Shiro自己也是有时间间隔机制，2分钟内不会重复执行该方法
        try
        {
            auditor=employeeService.getEmployee(account,password,"1");
        }
        catch (Exception e)
        {
            e.printStackTrace();
        ...
        SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(
                auditor.getString("employee_account"),
                auditor.getString("employee_password"),
