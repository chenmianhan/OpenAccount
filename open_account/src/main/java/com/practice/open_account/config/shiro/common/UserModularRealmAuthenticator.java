package com.practice.open_account.config.shiro.common;
 ...
 * <p>Title: UserModularRealmAuthenticator</p>  
 * <p>Description: </p>  
 * @author Adam 
 * @date 2018年8月14日
 */
    ...
    protected AuthenticationInfo doAuthenticate(AuthenticationToken authenticationToken)
       ...
       // System.out.println(loginType);
        ...
        for (Realm realm : realms) {
            //System.out.println(realm.getName()+"包含"+loginType+":"+realm.getName().contains(loginType));
            if (realm.getName().contains(loginType)) {
                typeRealms.add(realm);
            }

        }
        System.out.println(typeRealms.toString());
