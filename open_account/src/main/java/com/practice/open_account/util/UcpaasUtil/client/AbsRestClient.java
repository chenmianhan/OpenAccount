 ...
 * @project rest_demo
 */
package com.practice.open_account.util.UcpaasUtil.client;
...
public abstract class AbsRestClient {
	 ...
	 * @return
	 */
	public abstract String sendSms(String sid, String token, String appid, String templateid, String param, String mobile);
